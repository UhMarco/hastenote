    ...
    <>
      {editor.note
        ...
        <div className="w-full h-full flex flex-col justify-center items-center select-none space-y-5">
          ...
          <div className="cursor-pointer flex text-text-dark space-x-2 hover:bg-white/5 p-2 -mx-2 rounded-md" onClick={newNote}>
          ...
          {!user && <div className="cursor-pointer flex text-text-dark space-x-2 hover:bg-white/5 p-2 -mx-2 rounded-md" onClick={() => router.push("/signin")}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
